...
#    coords = parse_coords_from_mol(mol).flatten()
#    atoms = parse_atoms_from_mol(mol)
#    int_coords_list = np.hstack(parse_to_internal(mol))
#    typed_prims = own_to_pysisyphus(int_coords_list)
#    irc = RedundantCoords(atoms, coords, typed_prims=typed_prims)
#    internal_grads = irc.Bt_inv @ cart_grad
#
#    for i, cur in enumerate(int_coords_list):
#        if cur == cur_coord:
